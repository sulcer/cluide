...
![A pass over every screen: settings with its schema warnings, memory, rules, agents, skills, commands, hooks, plugins, MCP servers merged across scopes, then an edit, a save and its diff](docs/readme/tour.gif)

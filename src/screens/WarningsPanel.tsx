...
export function WarningsPanel({ errors, unavailable, onJump }: Props) {
  return (
    <aside
      aria-label="Warnings"
      className="flex h-[180px] shrink-0 flex-col border-t min-[1200px]:h-auto min-[1200px]:w-80 min-[1200px]:border-t-0 min-[1200px]:border-l"
    >
        ...
        <div className="min-h-0 flex-1 overflow-y-auto">
          {errors.map((e, i) => (
            <button
              ...
              className="block w-full border-b px-3 py-1.5 text-left hover:bg-accent"
            >
